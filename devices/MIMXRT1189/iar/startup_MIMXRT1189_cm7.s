...
__vector_table_0x1c
        ...
        DCD     SENTINEL_TRUST_MUA_RX_FULL_IRQHandler         ;Sentinel Trust MUA RX full interrupt
        DCD     SENTINEL_TRUST_MUA_TX_EMPTY_IRQHandler        ;Sentinel Trust MUA TX empty interrupt
        DCD     SENTINEL_APPS_CORE_MUA_RX_FULL_IRQHandler     ;Sentinel Apps Core MUA RX full interrupt
        DCD     SENTINEL_APPS_CORE_MUA_TX_EMPTY_IRQHandler    ;Sentinel Apps Core MUA TX empty interrupt
        DCD     SENTINEL_REALTIME_CORE_MUA_RX_FULL_IRQHandler    ;Sentinel Realtime Core MUA RX full interrupt
        DCD     SENTINEL_REALTIME_CORE_MUA_TX_EMPTY_IRQHandler    ;Sentinel Realtime Core MUA TX empty interrupt
        DCD     SENTINEL_SECURE_IRQHandler                    ;Sentinel secure interrupt
        DCD     SENTINEL_NONSECURE_IRQHandler                 ;Sentinel non-secure interrupt
        ...
        DCD     M33_PS_IRQHandler                             ;M33 PS Tag/Data Parity Error
        ...
        DCD     LDO_1P8_IRQHandler                            ;LDO 1P8 interrupt
        ...
        DCD     LDO_1P0_IRQHandler                            ;LDO 1P0 interrupt
        ...
        DCD     ECAT_IRQHandler                               ;ECAT interrupt
...
LPUART2_IRQHandler
        ...
        PUBWEAK SENTINEL_TRUST_MUA_RX_FULL_IRQHandler
        PUBWEAK SENTINEL_TRUST_MUA_TX_EMPTY_IRQHandler
        PUBWEAK SENTINEL_APPS_CORE_MUA_RX_FULL_IRQHandler
        PUBWEAK SENTINEL_APPS_CORE_MUA_TX_EMPTY_IRQHandler
        PUBWEAK SENTINEL_REALTIME_CORE_MUA_RX_FULL_IRQHandler
        PUBWEAK SENTINEL_REALTIME_CORE_MUA_TX_EMPTY_IRQHandler
        PUBWEAK SENTINEL_SECURE_IRQHandler
        PUBWEAK SENTINEL_NONSECURE_IRQHandler
...
PWM1_2_IRQHandler
PWM1_3_IRQHandler
SENTINEL_TRUST_MUA_RX_FULL_IRQHandler
SENTINEL_TRUST_MUA_TX_EMPTY_IRQHandler
SENTINEL_APPS_CORE_MUA_RX_FULL_IRQHandler
SENTINEL_APPS_CORE_MUA_TX_EMPTY_IRQHandler
SENTINEL_REALTIME_CORE_MUA_RX_FULL_IRQHandler
SENTINEL_REALTIME_CORE_MUA_TX_EMPTY_IRQHandler
SENTINEL_SECURE_IRQHandler
SENTINEL_NONSECURE_IRQHandler
TPM1_IRQHandler
TPM2_IRQHandler
RTWDOG1_IRQHandler
RTWDOG2_IRQHandler
