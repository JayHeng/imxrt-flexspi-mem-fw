 ...
 *
 * @param base DCDC peripheral base address.
 * @param targetVoltage The target value of VDD1P0 in standby mode, see @ref dcdc_1P0_target_vol_t.
 */
static inline void DCDC_SetVDD1P0StandbyModeTargetVoltage(DCDC_Type *base, dcdc_1P0_target_vol_t targetVoltage)
{
    base->REG3 &= ~DCDC_REG3_VDD1P0CTRL_DISABLE_STEP_MASK;
#if __CORTEX_M == 33
    base->TRG_SW_0 =
        ((base->TRG_SW_0) & (~DCDC_TRG_SW_0_VDD1P0CTRL_LP_TRG_MASK)) | DCDC_TRG_SW_0_VDD1P0CTRL_LP_TRG(targetVoltage);
#else
    base->TRG_SW_1 =
        ((base->TRG_SW_1) & (~DCDC_TRG_SW_1_VDD1P0CTRL_LP_TRG_MASK)) | DCDC_TRG_SW_1_VDD1P0CTRL_LP_TRG(targetVoltage);
#endif
 ...
 */
static inline void DCDC_SetVDD1P0BuckModeTargetVoltage(DCDC_Type *base, dcdc_1P0_target_vol_t targetVoltage)
{
    base->REG3 &= ~DCDC_REG3_VDD1P0CTRL_DISABLE_STEP_MASK;
#if __CORTEX_M == 33
    base->TRG_SW_0 =
 ...
 */
static inline void DCDC_SetVDD1P8TargetVoltage(DCDC_Type *base, dcdc_1P8_target_vol_t targetVoltage)
{
#if __CORTEX_M == 33
    base->TRG_SW_0 =
