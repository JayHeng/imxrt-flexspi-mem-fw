...
{
    kSRC_PDN_SentinelHandshake = 0UL, /*!< Power down sentinel handshake step. */
    ...
    kSRC_PUP_SentinelHandshake = 7UL, /*!< Power up sentinel handshake step. */
 ...
 */
static inline src_boot_fuse_selection_t SRC_GetBootFuseSelection(SRC_GENERAL_Type *base)
{
    return (src_boot_fuse_selection_t)(uint32_t)((base->SBMR2 & SRC_GENERAL_SBMR2_BT_FUSE_SEL_MASK) >>
                                                 SRC_GENERAL_SBMR2_BT_FUSE_SEL_SHIFT);
}
 ...
 */
static inline uint8_t SRC_GetSECConfigFuseState(SRC_GENERAL_Type *base)
{
    return (uint8_t)((base->SBMR2 & SRC_GENERAL_SBMR2_SEC_CONFIG_MASK) >> SRC_GENERAL_SBMR2_SEC_CONFIG_SHIFT);
}
