...
#define IOMUXC_CLOCKS                                    \
    {                                                    \
        kCLOCK_IpInvalid, kCLOCK_Iomuxc1, kCLOCK_Iomuxc2 \
    }
...
typedef enum _clock_lpcg
{
    ...
    kCLOCK_Sentinel    = 2,   /*!< Clock LPCG Sentinel    */
...
#define CCM_OBS_M33_CLK_ROOT         129, 0
...
#define CCM_OBS_M33_SYSTICK_CLK_ROOT 135, 0
...
#define CCM_OBS_PLL_SYS2_528_OUT     233, 2
#define CCM_OBS_PLL_SYS2_528_PFD0    234, 2
#define CCM_OBS_PLL_SYS2_528_PFD1    235, 2
#define CCM_OBS_PLL_SYS2_528_PFD2    236, 2
#define CCM_OBS_PLL_SYS2_528_PFD3    237, 2
#define CCM_OBS_PLL_SYS3_480_OUT     239, 2
#define CCM_OBS_PLL_SYS3_480_DIV2    240, 2
#define CCM_OBS_PLL_SYS3_480_PFD0    241, 2
#define CCM_OBS_PLL_SYS3_480_PFD1    242, 2
#define CCM_OBS_PLL_SYS3_480_PFD2    243, 2
#define CCM_OBS_PLL_SYS3_480_PFD3    244, 2
#define CCM_OBS_PLL_SYS1_1G_OUT      246, 2
#define CCM_OBS_PLL_SYS1_1G_DIV2     247, 2
#define CCM_OBS_PLL_SYS1_1G_DIV5     248, 2
...
static const clock_name_t s_clockSourceName[][4] = {
        ...
        {kCLOCK_OscRc24M, kCLOCK_OscRc400M, kCLOCK_SysPll1Out,  kCLOCK_SysPll2Pfd1,}, /* SENTINEL       2  */ \
...
typedef enum _clock_root
{
    ...
    kCLOCK_Root_Sentinel    = 2,  /*!< CLOCK Root Sentinel    */
...
typedef enum _clock_root_mux_source
{
    ...
    /* SENTINEL */
    kCLOCK_SENTINEL_ClockRoot_MuxOscRc24M    = 0U, /*!< SENTINEL mux from OscRc24M. */
    kCLOCK_SENTINEL_ClockRoot_MuxOscRc400M   = 1U, /*!< SENTINEL mux from OscRc400M. */
    kCLOCK_SENTINEL_ClockRoot_MuxSysPll1Out  = 2U, /*!< SENTINEL mux from SysPll1Out. */
    kCLOCK_SENTINEL_ClockRoot_MuxSysPll2Pfd1 = 3U, /*!< SENTINEL mux from SysPll2Pfd1. */
...
static inline bool CLOCK_IsPllBypassed(clock_pll_t pll)
{
    ...
    {
        return (bool)((ANADIG_PLL->PLL_528_CTRL & ANADIG_PLL_PLL_528_CTRL_BYPASS_MASK) >>
                      ANADIG_PLL_PLL_528_CTRL_BYPASS_SHIFT);
    }
    else if (pll == kCLOCK_PllSys3)
    {
        return (bool)((ANADIG_PLL->PLL_480_CTRL & ANADIG_PLL_PLL_480_CTRL_BYPASS_MASK) >>
                      ANADIG_PLL_PLL_480_CTRL_BYPASS_SHIFT);
    }
    else
    {
        return false;
...
static inline bool CLOCK_IsPllEnabled(clock_pll_t pll)
{
    ...
    {
        return (bool)((ANADIG_PLL->PLL_528_CTRL & ANADIG_PLL_PLL_528_CTRL_ENABLE_CLK_MASK) >>
                      ANADIG_PLL_PLL_528_CTRL_ENABLE_CLK_SHIFT);
    }
    else if (pll == kCLOCK_PllSys3)
    {
        return (bool)((ANADIG_PLL->PLL_480_CTRL & ANADIG_PLL_PLL_480_CTRL_ENABLE_CLK_MASK) >>
                      ANADIG_PLL_PLL_480_CTRL_ENABLE_CLK_SHIFT);
    }
    else if (pll == kCLOCK_PllSys1)
    {
        return (bool)((ANADIG_PLL->PLL_1G_CTRL & ANADIG_PLL_PLL_1G_CTRL_ENABLE_CLK_MASK) >>
                      ANADIG_PLL_PLL_1G_CTRL_ENABLE_CLK_SHIFT);
    }
...
/*!
 * @brief Set the control mode of 24MHz RC oscillator.
 *
 * @param controlMode The control mode to be set, please refer to @ref clock_control_mode_t.
 */
static inline void CLOCK_OSC_SetOscRc24MControlMode(clock_control_mode_t controlMode)
{
    ANADIG_OSC->OSC_RC24M_CTRL = (ANADIG_OSC->OSC_RC24M_CTRL & ~(ANADIG_OSC_OSC_RC24M_CTRL_RC_24M_CONTROL_MODE_MASK)) |
