...
- {id: M33_CLK_ROOT.outFreq, value: 24 MHz}
- {id: M33_SYSTICK_CLK_ROOT.outFreq, value: 24 MHz}
...
void BOARD_BootClockRUN(void)
{
    ...
    */
    ...
    /* Configure M33 using OSC_RC_48M_DIV2 */
    rootCfg.mux = kCLOCK_M33_ClockRoot_MuxOscRc48MDiv2;
    rootCfg.div = 1;
    CLOCK_SetRootClock(kCLOCK_Root_M33, &rootCfg);
    ...
    /* Configure M33_SYSTICK using OSC_RC_48M_DIV2 */
    rootCfg.mux = kCLOCK_M33_SYSTICK_ClockRoot_MuxOscRc48MDiv2;
    rootCfg.div = 1;
